    ...
    <footer className="footer">
      <div className="container footer-container">
        ...
        <div className="footer-right" style={{ textAlign: "center", justifyContent: "center" }}>
          <div className="footer-info" style={{ textAlign: "center" }}>
            <p className="footer-tagline">Rayfluxsolar - Harness the Power of the Sun ☀️</p>
            <p className="footer-separator">------</p>
            <div className="footer-cta-section">
              <h3>Call to Action Section</h3>
              <p>Switch to Solar. Save Money. Save the Planet.</p>
              <p>Start your solar journey today with Rayfluxsolar Business.</p>
              <p className="footer-contact">📞 8438438413 , 8807880764 | 📧rayfluxsolar@gmail.com</p>
            </div>
          </div>
        </div>
      </div> <br />
      <div className="footer-bottom">
        <div className="container">
          <p>Copyright 2026 | www.rayfluxsolar.com | All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
